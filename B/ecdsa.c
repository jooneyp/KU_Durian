...
int ECDSA_init(ECDSA_INFO *ecdsa, int curve, int hash_alg)
{
	...
	{
		case ECP224:
			InbySTR("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001", ecdsa->tmp_cdat, ecdsa->ec_ctx.prime);
			InbySTR("FFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D", ecdsa->tmp_cdat, ecdsa->ec_ctx.ord);
			InbySTR("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE", ecdsa->tmp_cdat, ecdsa->ec_ctx.a);
			InbySTR("B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4", ecdsa->tmp_cdat, ecdsa->ec_ctx.b);
			InbySTR("B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21", ecdsa->tmp_cdat, ecdsa->ec_ctx.base.x);
			InbySTR("BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34", ecdsa->tmp_cdat, ecdsa->ec_ctx.base.y);
