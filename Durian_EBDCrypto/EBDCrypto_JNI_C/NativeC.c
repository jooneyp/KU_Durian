#include "native_ebdcrypto.h"
#include "EBDCrypto.h"
#include "ca.h"

JNIEXPORT jint JNICALL Java_ebdcrypto_AES_nativeAESCBC (JNIEnv *env, jobject obj, jint encflag, jbyteArray userkey, jint key_offset, jint keylen, jbyteArray iv, jint iv_offset, jbyteArray input, jint input_offset, jint inlen, jbyteArray output, jint output_offset)
{
...
JNIEXPORT jint JNICALL Java_ebdcrypto_SHA2_nativesha224 (JNIEnv *env, jobject obj, jbyteArray input, jint input_offset, jint inlen, jbyteArray digest, jint output_offset)
{
	UCHAR *native_input = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, input, 0);
...
JNIEXPORT jint JNICALL Java_ebdcrypto_SHA2_nativesha256 (JNIEnv *env, jobject obj, jbyteArray input, jint input_offset, jint inlen, jbyteArray digest, jint output_offset)
{
	UCHAR *native_input = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, input, 0);
	UCHAR *native_digest = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, digest, 0);
...
JNIEXPORT jint JNICALL Java_ebdcrypto_SHA2_nativesha384 (JNIEnv *env, jobject obj, jbyteArray input, jint input_offset, jint inlen, jbyteArray digest, jint output_offset)
{
	UCHAR *native_input = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, input, 0);
	UCHAR *native_digest = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, digest, 0);
...
JNIEXPORT jint JNICALL Java_ebdcrypto_SHA2_nativesha512 (JNIEnv *env, jobject obj, jbyteArray input, jint input_offset, jint inlen, jbyteArray digest, jint output_offset)
{
	UCHAR *native_input = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, input, 0);
	UCHAR *native_digest = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, digest, 0);
...
JNIEXPORT jint JNICALL Java_ebdcrypto_DRBG_nativeDRBGRandomGen (JNIEnv *env, jobject obj, jbyteArray output, jint output_offset, jint request_num_of_bits)
{
	UCHAR *native_output = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, output, 0);
...
JNIEXPORT jint JNICALL Java_ebdcrypto_ECDSA_nativeECDSAgenkeypair (JNIEnv *env, jobject obj, jbyteArray qx, jint qx_offset, jintArray qx_len, jbyteArray qy, jint qy_offset, jintArray qy_len, jbyteArray d, jint d_offset, jintArray d_len)
{
...
JNIEXPORT jint JNICALL Java_ebdcrypto_ECDSA_nativeECDSAgeneratesignature (JNIEnv *env, jobject obj, jint hash_alg, jbyteArray d, jint d_offset, jint d_len, jbyteArray msg, jint msg_offset, jint msg_len, jbyteArray r, jint r_offset, jintArray r_len, jbyteArray s, jint s_offset, jintArray s_len)
{
	UCHAR *native_d = (unsigned char *)(*env)->GetPrimitiveArrayCritical(env, d, 0);
...
JNIEXPORT jbyteArray JNICALL Java_ebdcrypto_GenerateCertCSR_nativeGenPubCSR (JNIEnv *env, jobject obj,
